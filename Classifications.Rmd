...
Considerăm valoarea de 0.3 drept prag pentru clasificarea in Yes/No:
```{r}
...
df_roc <- data.frame(actual.class = test$potability, probability = pred_lr_roc, pred_nb_roc, pred_tree_roc, pred_bagging_roc, pred_rf_roc)
